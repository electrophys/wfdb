...
/* Build configuration (version, feature flags, paths).
   wfdb_config.h is generated by configure with #ifndef guards, so
   the library build's -D compiler flags take precedence. */
#include "wfdb_config.h"
